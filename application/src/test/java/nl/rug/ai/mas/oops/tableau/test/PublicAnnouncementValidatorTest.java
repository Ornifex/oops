...
import nl.rug.ai.mas.oops.tableau.PublicAnnouncementValidator;
...
public class PublicAnnouncementValidatorTest {
    ...
    public void testValidate() {
        FormulaValidator v = new PublicAnnouncementValidator();
        ...
        assertTrue(v.validate(parse("a ! b")));
        assertTrue(v.validate(parse("a ? b")));
    }
}

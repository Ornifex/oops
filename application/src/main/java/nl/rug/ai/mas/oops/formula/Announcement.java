...
public class Announcement implements ModalF {
    ...
    public Announcement(Formula l, Formula r) {
        d_left = l;
        d_right = r;
    ...
    public Formula substitute(FullSubstitution s) {
        return new Announcement(d_left.substitute(s), d_right.substitute(s));
    }

    public void accept(FormulaVisitor v) {
        d_left.accept(v);
        d_right.accept(v);
        v.visitAnnouncement(this);
    }
